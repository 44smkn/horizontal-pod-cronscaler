...
func (in *HorizontalPodCronscaler) DeepCopy() *HorizontalPodCronscaler {
	...
	out := new(HorizontalPodCronscaler)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HorizontalPodCronscalerList) DeepCopyInto(out *HorizontalPodCronscalerList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]HorizontalPodCronscaler, len(*in))
		for i := range *in {
...
func (in *HorizontalPodCronscalerList) DeepCopy() *HorizontalPodCronscalerList {
	...
	out := new(HorizontalPodCronscalerList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HorizontalPodCronscalerSpec) DeepCopy() *HorizontalPodCronscalerSpec {
	...
	out := new(HorizontalPodCronscalerSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HorizontalPodCronscalerStatus) DeepCopyInto(out *HorizontalPodCronscalerStatus) {
	*out = *in
	if in.LastTargetReplicas != nil {
		in, out := &in.LastTargetReplicas, &out.LastTargetReplicas
		*out = new(int32)
		**out = **in
	}
	in.LastSchedule.DeepCopyInto(&out.LastSchedule)
}
...
func (in *HorizontalPodCronscalerStatus) DeepCopy() *HorizontalPodCronscalerStatus {
	...
	out := new(HorizontalPodCronscalerStatus)
	in.DeepCopyInto(out)
	return out
}
